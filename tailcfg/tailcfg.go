...
// CapabilityName is a string used to identify a specific capability. Its
// meaning is application-defined.
//
// It must be a URL like "https://tailscale.com/cap/file-send", or a well-known
// capability name like 'funnel'.
type CapabilityName string

// NodeCapability is a capability granted to a node.
//
// Unlike PeerCapability, NodeCapability is not in context of a peer and is
// granted to the node itself.
type NodeCapability CapabilityName

// PeerCapability is a capability granted to a peer by a FilterRule when the
// peer communicates with the node that has this rule.
type PeerCapability CapabilityName
